...
//
//	-X github.com/As-tsaqib/picoclaw/pkg/config.Version=<version>
//	-X github.com/As-tsaqib/picoclaw/pkg/config.GitCommit=<commit>
//	-X github.com/As-tsaqib/picoclaw/pkg/config.BuildTime=<timestamp>
//	-X github.com/As-tsaqib/picoclaw/pkg/config.GoVersion=<go-version>
var (
