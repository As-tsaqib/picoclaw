...
import (
	...
	"github.com/As-tsaqib/picoclaw/pkg"
)
	...
	return &Config{
		...
		Memory: MemoryConfig{
			...
			Retrieval: MemoryRetrievalConfig{
				...
				MaxWorkspaceResults: DefaultMemoryWorkspaceResults,
				MaxUserResults:      DefaultMemoryUserResults,
				MaxTotalChars:       DefaultMemoryRetrievalChars,
				PinnedCharBudget:    DefaultMemoryPinnedChars,
				MinimumScore:        DefaultMemoryMinRelevance,
				RecencyWeight:       DefaultMemoryRecencyWeight,
			...
			Lifecycle: MemoryLifecycleConfig{
				...
				StaleThresholdDays:    DefaultMemoryStaleThreshold,
		...
		Evolution: EvolutionConfig{
			...
			ApplyPolicy:          EvolutionApplyApprovalRequired,
			PrivateDataScrubbing: true,
			DraftTimeoutSeconds:  DefaultEvolutionDraftTimeout,
			MaxEvidenceRecords:   DefaultEvolutionMaxEvidence,
			MaxDraftChars:        DefaultEvolutionMaxDraftChars,
			RollbackRetention:    DefaultEvolutionRollbackKeep,
		},
