...
import (
    "github.com/As-tsaqib/picoclaw/pkg/bus"
    "github.com/As-tsaqib/picoclaw/pkg/channels"     // 引用父包
    "github.com/As-tsaqib/picoclaw/pkg/config"
    "github.com/As-tsaqib/picoclaw/pkg/identity"      // 新增
    "github.com/As-tsaqib/picoclaw/pkg/media"          // 新增（如需媒体）
)
```
...
import (
    _ "github.com/As-tsaqib/picoclaw/pkg/channels/telegram"   // 触发 init() 注册
    _ "github.com/As-tsaqib/picoclaw/pkg/channels/discord"
    _ "github.com/As-tsaqib/picoclaw/pkg/channels/your_new_channel"  // 新增
)
```
